...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				<!-- Topbar -->
				<nav id="bt1" class="navbar navbar-expand navbar-light text-white topbar mb-4 static-top shadow">
					...
					<div class="input-group">
						...
						<!--<p class="ml-auto text-dark"><strong>Peru, </strong><?php echo fechaPeru(); ?></p>-->
					</div>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<h5><span class="mr-2 d-none d-lg-inline small text-dark"><?php echo $_SESSION['nombre']; ?></span></h5>
							</a>
